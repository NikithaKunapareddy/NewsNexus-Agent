...
const darkTheme = {
  background: 'linear-gradient(135deg, #3a1c71 0%, #6d5bba 50%, #8f94fb 100%)', // purple gradients only
  card: 'rgba(58,28,113,0.97)', // deep purple with opacity
  text: '#f3eaff',
  input: 'rgba(58,28,113,0.85)',
  border: '#8f94fb',
  button: 'linear-gradient(90deg, #8f94fb 0%, #6d5bba 100%)', // purple-blue button
  buttonText: '#fff',
